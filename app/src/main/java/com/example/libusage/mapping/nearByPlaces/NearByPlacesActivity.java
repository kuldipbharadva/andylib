...
public class NearByPlacesActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context,"Nearby Restaurants", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnSchool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(context,"Nearby Schools", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyCBgLR5za4rxOsliNVwClONjESs-e-kb6o");
